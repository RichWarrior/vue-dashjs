    ...
    <v-col class="pa-1" cols="12" lg="4" md="4">
      <v-hover v-slot:default="{hover}">
        <v-card :elevation="hover ? 12 :2">
          ...
          <v-card-text>
            <v-row class="ma-0">
              <v-col class="pa-1 text-center" cols="12">
                <span class="black--text">PASSWORD RESET</span>
              </v-col>
              <v-col class="pa-1 text-center" cols="12">
                <span class="black--text">Fii with your mail to receive instructions on how to reset your password.</span>
              </v-col>
            </v-row>
            <v-row class="ma-0">
                <v-col class="pa-1" cols="12">
                    ...
                    <v-btn block color="error" @click="$router.push({path:'/Login'})">
                        Reset
                    </v-btn>
                </v-col>
            </v-row>
